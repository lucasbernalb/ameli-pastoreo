...
export const CinematicLanding = () => {
  return (
    <div className="min-h-screen bg-cream-texture">
      ...
      >
        <ImageMaskReveal
          image="/images/optimized/yolk-hover.webp"
          video="/videos/video-llema-callendo.mp4"
          alt="Yema de huevo cayendo"
          label="La diferencia"
          headline="Se ve en la yema"
          body="Una yema de color naranja intenso no es casualidad. Es el resultado directo de una alimentación natural y gallinas que viven felices."
        />
