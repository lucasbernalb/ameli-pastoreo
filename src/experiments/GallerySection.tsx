      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <motion.div
            ...
            className="relative rounded-[24px] overflow-hidden shadow-xl group"
          >
            <img
              src={items[0].image}
              alt={items[0].alt}
              className="w-full h-full object-cover min-h-[320px] md:min-h-[600px] transition-transform duration-700 group-hover:scale-[1.03]"
              loading="lazy"
            />
          ...
          <div className="flex flex-col gap-6">
            <motion.div
              variants={itemVariants}
              className="rounded-[24px] p-6 md:p-8 shadow-md"
              style={{
            ...
            >
              ...
              <h2 className="font-playfair text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mt-2">
